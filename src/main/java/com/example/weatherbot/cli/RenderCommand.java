package com.example.weatherbot.cli;

import com.example.weatherbot.WeatherBotConfiguration;
...
public class RenderCommand extends ConfiguredCommand<WeatherBotConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<WeatherBotConfiguration> bootstrap,
                       Namespace namespace,
                       WeatherBotConfiguration configuration) throws Exception {
